...
Stream APIs build on top of the Storm's spouts and bolts to provide a typed for expressing streaming computations and supports functional style operations such as map-reduce. 
